...
const typed = new Typed('#prompts-sample', {
    strings: ["Біз сізге жарық диодты масканы ұсынамыз — бет терісін жасарту және безеулермен күресу үшін инновациялық шешім. Бұл маска әртүрлі түсті жарық диодтарымен жабдықталған, олар әртүрлі толқын ұзындықтарында жұмыс істейді және терінің денсаулығын жақсартуға бағытталған. Жасартудың үшін, жарық диодтары коллаген өндірісін және терінің серпімділігін ынталандырады, оның текстурасын және тонусын жақсартады. Безеулермен күресу үшін, жарық диодтары тесіктерді тарылтуға, қабынуды азайтуға және бактерияларды жоюға көмектеседі, терінің жағдайын жақсартуға көмектеседі. Жарық диодты маска пайдалануға қауіпсіз және үйде пайдалануға ыңғайлы. Біздің масканың көмегімен теріңізді өзгертіңіз және жас әрі дені сау келбетпен ләззат алыңыз. - Атауы: Бет терісін жасарту үшін жарық диодты маска. Безеулермен күресу маскасы - Қызметтері: Терісін жасарту, безеулермен күрес - Жарық диодтары: Әртүрлі толқын ұзындықтары бар әртүрлі түсті жарық диодтары - Пайдалану әдісі: Масканы бетте ұсынылған уақыт ішінде ұстау - Қауіпсіздік: Қауіпсіз пайдалану және жағымсыз сезімдердің болмауы - Ыңғайлылық: Үй жағдайында пайдалануға болады. Мақсаты тесіктерді тарылту, қартаюға қарсы күтім, акне емдеу, терінің серпімділігін арттыру, беттің тегіс түсі, пигменттік дақтарды ағарту", 
                ],
    typeSpeed: 0.2,
...
sections.forEach((sec) => {
    ...
    const revealUptimeline = gsap.timeline({paused: true, 
                                            scrollTrigger: {
                                                            trigger: sec,
                                                            start: "top 95%", // top of trigger hits the top of viewport
                                                            end: "20% 90%",
                                                            // markers: true,
                                                            // scrub: 1,
                                                        }})
