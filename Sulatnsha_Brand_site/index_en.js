...
const typed = new Typed('#prompts-sample', {
    strings: ["We present you our LED mask — an innovative solution for facial skin rejuvenation and acne treatment. This mask is equipped with colorful LEDs that operate at different wavelengths and are aimed at improving skin health. For rejuvenation, the LEDs stimulate collagen and skin elasticity production, improving its texture and tone. For acne treatment, the LEDs help reduce pore size, decrease inflammation, and destroy bacteria, helping improve skin condition. The LED mask is safe to use and convenient for home use. Transform your skin with our mask and enjoy a youthful and healthy appearance. - Name: LED mask for facial skin rejuvenation. Mask for acne treatment - Functions: Skin rejuvenation, acne treatment - LEDs: Colorful LEDs with different wavelengths - Usage method: Keep the mask on your face for the recommended time - Safety: Safe to use without discomfort - Convenience: Can be used at home. Purpose: pore tightening, anti-aging care, acne treatment, increased skin elasticity, even facial tone, lightening of pigmented spots", 
                ],
    typeSpeed: 0.2,
